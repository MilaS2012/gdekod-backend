...
| `private-api/` | Auth + email-привязка + сессии (`/auth/*`, `/auth/email/*`, `/auth/banner/dismiss`, `/auth/sessions`, `/auth/logout-all`), `requireUser` middleware, rate-limit, mask-pii | 🟡 6.1–6.5 готовы, 6.6–6.11 в работе | 304 / 304 (`node:test`), coverage 92.95% |
...
| 6.6–6.11 | Приватный API: подписки, аккаунт, парсер, 152-ФЗ, support, финал | `private-api/` | — |
